  ...
  verbose_(ps.getParameter<bool>("verbose"))
{
  ...
  hists_2d_["h_l1pt_recopt"] = fs->make<TH2F>("h_l1pt_recopt" , "; L1 pt [GeV]; reco pt [GeV]" , 50 , 0. , 100., 50, 0., 100. );
  ...
  hists_2d_["h_goodptphi_l1eta_recoeta"] = fs->make<TH2F>("h_l1eta_recoeta" , "; L1 #eta; reco #eta" , 120 , -3. , 3., 120, -3., 3. );
